...
svm = SVC(kernel='rbf', random_state=0, gamma=0.4, C=0.25)
svm.fit(rf_x_train, y_train)
print("With Random forest feature selection")
print('訓練集: ', svm.score(rf_x_train,y_train))
print('測試集: ', svm.score(rf_x_test,y_test))
print(confusion_matrix(y_test, svm.predict(rf_x_test)))
print(classification_report(y_test, svm.predict(rf_x_test)))

svm = SVC(kernel='rbf', random_state=0, gamma=0.4, C=0.25)
svm.fit(X_train, y_train)
print("Without Random forest feature selection")
print('訓練集: ', svm.score(X_train,y_train))
print('測試集: ', svm.score(X_test,y_test))
