...
print('best_accuracy: ', best_accuracy) # best_accuracy:  0.8245102723363592
print('best_parameters: ', best_parameters) # best_parameters:  {'criterion': 'entropy', 'n_estimators': 100}
